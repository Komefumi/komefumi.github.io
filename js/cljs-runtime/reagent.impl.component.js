...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22121 = c;
var G__22121__$1 = (((G__22121 == null))?null:G__22121.prototype);
if((G__22121__$1 == null)){
return null;
} else {
return G__22121__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22122 = c;
var G__22122__$1 = (((G__22122 == null))?null:G__22122.prototype);
if((G__22122__$1 == null)){
return null;
} else {
return G__22122__$1.render;
}
})() == null)))));
});
...
var or__5162__auto__ = (function (){var G__22131 = c;
var G__22131__$1 = (((G__22131 == null))?null:G__22131.constructor);
if((G__22131__$1 == null)){
return null;
} else {
return G__22131__$1.displayName;
}
})();
...
var G__22138 = c;
var G__22138__$1 = (((G__22138 == null))?null:G__22138.constructor);
if((G__22138__$1 == null)){
return null;
} else {
return G__22138__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22162 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22163 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22163);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22162);
}});
...
var c = this;
var G__22202_22224 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22202_22224 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22202_22224);
}
...
var renders_22225 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22226 = cljs.core.first(cljs.core.vals(renders_22225));
...
if((cljs.core.count(renders_22225) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_22225))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_22226)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22226], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}


var render_fun = (function (){var or__5162__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var name = (function (){var or__5162__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var G__22203 = o;
reagent.impl.component.goog$module$goog$object.set(G__22203,cljs.core.name(k),v);
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn((""+"Warning: "+"Using native React classes directly in Hiccup forms "+"is not supported. Use create-element or "+"adapt-react-class instead: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5162__auto__ = reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return f;
...
var _STAR_current_component_STAR__orig_val__22204 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22205 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22205);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22204);
}});
...
var vec__22206 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22206,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22206,(1),null);
...
var G__22209 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22209 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22209);
}
});
}),[]);
