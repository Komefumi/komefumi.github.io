...
var i_12764 = (self__.level + (1));
while(true){
if((i_12764 <= (new_level + (1)))){
(update[i_12764] = self__.header);

var G__12768 = (i_12764 + (1));
i_12764 = G__12768;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12769 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12769[i]));
} else {
x__$2.forward.push((((i < links_12769.length))?(links_12769[i]):null));
}

if((i < links_12769.length)){
(links_12769[i] = x__$2);
} else {
links_12769.push(x__$2);
}
...
var i_12780 = (0);
while(true){
if((i_12780 <= self__.level)){
var links_12781 = (update[i_12780]).forward;
if((x__$1 === (((i_12780 < links_12781.length))?(links_12781[i_12780]):null))){
(links_12781[i_12780] = (x__$1.forward[i_12780]));

var G__12783 = (i_12780 + (1));
i_12780 = G__12783;
continue;
} else {
var G__12784 = (i_12780 + (1));
i_12780 = G__12784;
continue;
}
} else {
...
var G__12797 = nx;
var G__12798 = (level__$1 - (1));
x = G__12797;
level__$1 = G__12798;
continue;
} else {
var G__12799 = x;
var G__12800 = (level__$1 - (1));
x = G__12799;
level__$1 = G__12800;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__12803 = nx;
var G__12804 = (level__$1 - (1));
x = G__12803;
level__$1 = G__12804;
continue;
} else {
var G__12805 = x;
var G__12806 = (level__$1 - (1));
x = G__12805;
level__$1 = G__12806;
continue;
}
