...
(reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__22235 = o;
reagent.impl.template.goog$module$goog$object.set(G__22235,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22255__delegate = function (args){
...
while (G__22256__i < G__22256__a.length) {G__22256__a[G__22256__i] = arguments[G__22256__i + 0]; ++G__22256__i;}
  args = new cljs.core.IndexedSeq(G__22256__a,0,null);
} 
return G__22255__delegate.call(this,args);};
...
return G__22255__delegate(args);
});
...
var G__22236 = o;
reagent.impl.template.goog$module$goog$object.set(G__22236,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22259__i < G__22259__a.length) {G__22259__a[G__22259__i] = arguments[G__22259__i + 0]; ++G__22259__i;}
  args = new cljs.core.IndexedSeq(G__22259__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22260);
...
var G__22237 = props;
var G__22237__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22237,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22237);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22237__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22238 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22238,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22238;
}
})(),id_class);
...
var G__22239 = (cljs.core.count(argv) - first_child);
switch (G__22239) {
case (0):
...
(reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__22240 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22240,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22240,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22240,(2),null);
...
var temp__5829__auto___22262 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22262 == null)){
} else {
var key_22263 = temp__5829__auto___22262;
(jsprops.key = key_22263);
}
...
var temp__5829__auto___22264 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22264 == null)){
} else {
var key_22265 = temp__5829__auto___22264;
(jsprops.key = key_22265);
}
...
var jsprops = (function (){var or__5162__auto__ = reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return ({});
...
var temp__5829__auto___22268 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22268 == null)){
} else {
var key_22269 = temp__5829__auto___22268;
(jsprops.key = key_22269);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__5162__auto__ = reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return ({});
...
var input_class = (function (){var or__5162__auto__ = compiler.reagentInput;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var temp__5829__auto___22273 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22273 == null)){
} else {
var key_22275 = temp__5829__auto___22273;
(jsprops.key = key_22275);
}
...
var jsprops = (function (){var or__5162__auto__ = props;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return ({});
...
var temp__5829__auto___22276 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22276 == null)){
} else {
var key_22277 = temp__5829__auto___22276;
(jsprops.key = key_22277);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22245_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22245_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22246 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22246,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22246,(1),null);
...
break;
default:
var G__22279 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22280 = compiler;
v = G__22279;
compiler = G__22280;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22252 = (function (opts,id,fn_to_element,parse_fn,meta22253){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22252.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22254,meta22253__$1){
var self__ = this;
var _22254__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22252(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22253__$1));
}));

(reagent.impl.template.t_reagent$impl$template22252.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22254){
var self__ = this;
var _22254__$1 = this;
return self__.meta22253;
}));

(reagent.impl.template.t_reagent$impl$template22252.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22252.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22252.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22252.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22252.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22252.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22253","meta22253",162297272,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22252.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22252.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22252");

(reagent.impl.template.t_reagent$impl$template22252.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/t_reagent$impl$template22252");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22252.
 */
reagent.impl.template.__GT_t_reagent$impl$template22252 = (function reagent$impl$template$__GT_t_reagent$impl$template22252(opts,id,fn_to_element,parse_fn,meta22253){
return (new reagent.impl.template.t_reagent$impl$template22252(opts,id,fn_to_element,parse_fn,meta22253));
});
...
return (new reagent.impl.template.t_reagent$impl$template22252(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
